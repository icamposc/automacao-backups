...
def executar_backup(self, email: str, ticket_id: str, nome: str = None, deletar_conta: bool = True) -> None:
    """
    Tarefa Celery que executa o fluxo completo de backup.

    Chamada via: executar_backup.delay(email, ticket_id, nome, deletar_conta)
    ...
    executar_backup_direto(email, ticket_id, nome, deletar_conta=deletar_conta)
